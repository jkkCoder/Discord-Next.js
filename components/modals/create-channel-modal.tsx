                            ...
                            <FormField control={form.control}
                                ...
                                render={({field}) => (
                                    <FormItem>
                                        ...
                                        <FormControl>
                                            <Input {...field} placeholder="Enter channel name" disabled={isLoading} className="bg-zinc-300/50 border-0 focus-visible:ring-0 text-blac focus-visible:ring-offset-0"/>
                                        </FormControl>
                                        <FormMessage />
                                    </FormItem>
                                )}
